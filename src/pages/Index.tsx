...
const Index = () => {
  ...
  const initLocations = (): Location[] => [
    { id: '1', name: 'Аристотель', status: 'current', x: 50, y: 12, connections: ['2', '2А', '2Б'] },
    { id: '2', name: 'Коменский', status: 'locked', x: 45, y: 22, connections: ['3'] },
    { id: '2А', name: 'Коменский', status: 'locked', x: 25, y: 25, connections: ['3А'] },
    { id: '2Б', name: 'Коменский', status: 'locked', x: 70, y: 20, connections: ['3Б', '3В'] },
    { id: '3', name: 'Песталоцци', status: 'locked', x: 55, y: 35, connections: ['4'] },
    { id: '3А', name: 'Песталоцци', status: 'locked', x: 20, y: 38, connections: ['4А', '4В', '4Б'] },
    { id: '3Б', name: 'Песталоцци', status: 'locked', x: 75, y: 32, connections: ['4А', '4Б', '4В'] },
    { id: '3В', name: 'Песталоцци', status: 'locked', x: 12, y: 47, connections: ['4А', '4Б', '4В'] },
    { id: '4', name: 'Ушинский', status: 'locked', x: 60, y: 47, connections: ['5'] },
    { id: '4А', name: 'Ушинский', status: 'locked', x: 25, y: 52, connections: ['5А'] },
    { id: '4Б', name: 'Ушинский', status: 'locked', x: 80, y: 45, connections: ['5Б'] },
    { id: '4В', name: 'Ушинский', status: 'locked', x: 10, y: 59, connections: ['5В'] },
    { id: '5', name: 'Макаренко', status: 'locked', x: 55, y: 59, connections: ['6'] },
    { id: '5А', name: 'Макаренко', status: 'locked', x: 30, y: 65, connections: ['6А'] },
    { id: '5Б', name: 'Макаренко', status: 'locked', x: 75, y: 57, connections: ['6Б'] },
    { id: '5В', name: 'Макаренко', status: 'locked', x: 15, y: 72, connections: ['6В'] },
    { id: '6', name: 'Выготский', status: 'locked', x: 50, y: 71, connections: ['7'] },
    { id: '6А', name: 'Выготский', status: 'locked', x: 35, y: 77, connections: ['7А'] },
    { id: '6Б', name: 'Выготский', status: 'locked', x: 70, y: 69, connections: ['7Б'] },
    { id: '6В', name: 'Выготский', status: 'locked', x: 20, y: 82, connections: ['7В'] },
    { id: '7', name: 'Сухомлинский', status: 'locked', x: 45, y: 83, connections: ['8'] },
    { id: '7А', name: 'Сухомлинский', status: 'locked', x: 40, y: 88, connections: ['8А'] },
    { id: '7Б', name: 'Сухомлинский', status: 'locked', x: 65, y: 81, connections: ['8Б'] },
    { id: '7В', name: 'Сухомлинский', status: 'locked', x: 25, y: 91, connections: ['8В'] },
    { id: '8', name: 'Монтессори', status: 'locked', x: 50, y: 93, connections: [] },
    { id: '8А', name: 'Монтессори', status: 'locked', x: 35, y: 95, connections: [] },
    { id: '8Б', name: 'Монтессори', status: 'locked', x: 70, y: 90, connections: [] },
    { id: '8В', name: 'Монтессори', status: 'locked', x: 20, y: 97, connections: [] }
  ];
